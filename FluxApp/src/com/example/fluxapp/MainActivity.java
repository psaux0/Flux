...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button openButton = (Button) findViewById(R.id.bBTon);
		Button closeButton = (Button) findViewById(R.id.bBToff);
		Button heatOn = (Button) findViewById(R.id.btnOn);
		Button heatOff = (Button) findViewById(R.id.btnOff);
		myLabel = (TextView) findViewById(R.id.tvStatus);
